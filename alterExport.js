...
async function exportAll() {
    const isMod = n => !n.endsWith('.json') && !n.endsWith('.html') && !n.endsWith('.css') && !n.endsWith('.md') && !n.endsWith('.txt') && !['SlaytabaseModStSExporter', 'basemod', 'colors', 'extraImages'].includes(n);
